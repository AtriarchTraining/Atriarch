...
void setup() {
  ...
  // Zero the ACK / heartbeat / drill tracking arrays. Without this, bss
  // is already zeroed on AVR boot so this is defensive/explicit.
...
void handleSnap() {
  Serial.print("SNAP_REPLY/");
  Serial.print(drillRunning ? 1 : 0);
  Serial.print("/");
