...
class TargetChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final labelText = '${target.label}$suffix';
    final showGroupBadge = target.groupId != null;
  ...
  String _semanticsLabel(_TargetChipState state) {
    final parts = <String>['Target ${target.id}'];
    if (target.displayName != null) parts.add(target.displayName!);
    switch (state) {
      case _TargetChipState.offline:
        parts.add('offline');
        break;
