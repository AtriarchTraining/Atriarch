...
class _CalculatorScreenState extends State<CalculatorScreen> {
                      ...
                      children: [
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(plus20 == 0.0 ? '-' : plus20.toString(),
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(plus10 == 0.0 ? '-' : plus10.toString(),
                                  style: TextStyle(fontSize: 16))
                            ],
                          ),
                        ),
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text('< -10%', style: TextStyle(fontSize: 16)),
                              Text(minus10 == 0.0 ? '-' : minus10.toString(),
                                  style: TextStyle(fontSize: 16))
                            ],
                          ),
                        ),
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text('< -20%', style: TextStyle(fontSize: 16)),
                              Text(minus20 == 0.0 ? '-' : minus20.toString(),
                                  style: TextStyle(fontSize: 16))
                            ],
                          ),
                        ),
                  ...
                  children: [
                    MaterialButton(
                      ...
                      onPressed: () {
                        ...
                        setState(() {
                          avg = (sum / (counter));
                          String inString = avg.toStringAsFixed(2);
                          avg = double.parse(inString);

                          plus10 = avg + (avg * 0.1);
                          inString = plus10.toStringAsFixed(2);
                          plus10 = double.parse(inString);

                          plus20 = avg + (avg * 0.2);
                          inString = plus20.toStringAsFixed(2);
                          plus20 = double.parse(inString);

                          minus10 = avg - (avg * 0.1);
                          inString = minus10.toStringAsFixed(2);
                          minus10 = double.parse(inString);

                          minus20 = avg - (avg * 0.2);
                          inString = minus20.toStringAsFixed(2);
  ...
  void getNotifications() async {
    try {
      await widget.chObj1!.setNotifyValue(true);
      widget.chObj1!.onValueReceived.listen((value) {
        if (this.mounted) {
          setState(() {
